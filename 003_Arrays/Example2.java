...
public class Example2 {
    ...
    public static int findMissingNumberBrute(int[] nums, int n) {
    ...
    public static int maxConsequtiveOnesBrute(int[] nums) {
    ...
    public static int numberAppearsOnceBetter(int[] nums) {
    ...
    public static int numberAppearsOnceBrute(int[] nums) {
    ...
    public static long longestSubArraySumKPositivesBetter(int[] nums, int k) {
    ...
    public static long longestSubArraySumKPositivesBrute(int[] nums, int k) {
    ...
    public static int longestSubArraySumKNegativesBetter(int[] nums, int k) {
